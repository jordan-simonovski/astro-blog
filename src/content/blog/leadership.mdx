...
<Tweet
  url="https://twitter.com/sarahmei/status/862583216095416320"
  author="Sarah Mei"
  date="2017-05-11"
>
  1\. Becoming a manager is not a promotion - it's a lateral move onto a
...
<Figure src="leadership-behaviour.png" alt={"leadership behaviours"} />
...
<Figure src="master-autonomy-purpose.jpg" alt={"mastery-autonomy-purpose"} />
...
<Figure src="maslow.webp" alt={"Maslow's hierarchy of needs"} />
...
<Figure src="morty-todo-list.jpg" alt={"I do ass the to-do list guides"} />
...
<Figure
  src="out-of-touch-manager.jpg"
  alt={"Am I out of touch? No, it' the employees who are wrong"}
/>
